...
let questoes = ["Complete: seu amigo foi atacado pelo dementador, então você...", "O que você frequentemente mais ouve?", "Você fácilmente ama alguém?", "você sente vontade de realizar alguma vingança?", "Qual seria a sua abordagem ao enfrentar um desafio difícil?", "Como você prefere passar seu tempo livre?", "você mente aos outros facilmente?", "Se você terminasse um namoro com alguém, como ficaria?", "Se o seu melhor amigo se afastasse de você, como você ficaria?"] 
...
let respostas5 = ["Lendo e estudando", "Explorando ideias", "Com meus amigos", "Mechendo no celular"]
